 ...
 * Generated at: 2020-03-26 05:37:53 UTC
...
if("10".equals(request.getParameter("pageId"))) { 
      ...
      out.write("                    \r\n");
      out.write("                    <div>\r\n");
      out.write("                        <div class=\"diyDiv mb-4\" style=\"display: inline-block; width: 20%\">\r\n");
 ...
 if(list.size() != 0) { 
      ...
      out.write("                            \r\n");
      out.write("                        </div>\r\n");
      out.write("                        <div class=\"diyDiv\" style=\"display: inline-block; width: 79%;\">\r\n");
      out.write("                            <label>\r\n");
      out.write("                            \t");
 if(list.size() != 0) { 
      out.write(' ');
      out.print(list.get(0).getWorktitle());
      out.write(' ');
}
      out.write("\r\n");
      out.write("                            </label>\r\n");
      ...
      out.write("                        <div class=\"card-header\"><i class=\"fas fa-table mr-1\"></i>작품 에피소드 조회 목록\r\n");
      out.write("                            <button class=\"btn btn-primary\" style=\"float:right;\" id=\"searchBtn\">검색</button>\r\n");
      out.write("                            <input type=\"text\" class=\"search\" id=\"epiSearch\" style=\"float: right; width:220px;\" placeholder=\"에피소드명을 입력하세요\">\r\n");
      out.write("                            \r\n");
      out.write("                        </div>\r\n");
      ...
      out.write("                                            <th style=\"width: 60%;\">Episode</th>\r\n");
      out.write("                                            <th style=\"width: 20%;\">Secret</th>\r\n");
      out.write("                                        </tr>\r\n");
      out.write("                                    </thead>\r\n");
      out.write("                                    \r\n");
      out.write("                                    <tbody>\r\n");
...
if(list.size() != 0) { 
 ...
 for(Work w : list) { 
      ...
      out.print(w.getEpisodeNo());
      out.write("\"></td>\r\n");
      out.write("\t                                            <td><a href=\"#\">");
      out.print(w.getEpisodeTitle() );
      out.write("</a></td>\r\n");
      out.write("\t                                            <td>\r\n");
      out.write("\t                                            \t");
if(w.getSecretFlag().equals("N")) { 
 ...
 if(search != null) { 
      ...
      out.print(contextPath);
      out.write("/adSearch.ep?pageId=4&&no=");
      out.print(workNo);
      out.write("&&search=");
      out.print(search );
...
if(currentPage == maxPage){ 
 ...
 scrMsg = null; 
      ...
      out.write("                    var search = $(\"#epiSearch\").val();\r\n");
      out.write("                    location.href = \"");
      out.print(contextPath);
      out.write("/adSearch.ep?pageId=4&&no=\" + workNo + \"&&search=\" + search;\r\n");
      out.write("                 });\r\n");
      out.write("            \t\r\n");
      out.write("            \t// 숨김처리\r\n");
      ...
      out.write("        \t\t\t\tlocation.href = \"");
      out.print(contextPath);
      out.write("/adScrt.ep?pageId=4&&div=1&&workNo=\" + workNo + \"&&no=\" + scrNo;\r\n");
      out.write("        \t\t\t} else {\r\n");
      ...
      out.write("        \t\t\t\tlocation.href = \"");
      out.print(contextPath);
      out.write("/adScrt.ep?pageId=4&&div=2&&workNo=\" + workNo + \"&&no=\" + scrNo;\r\n");
      out.write("        \t\t\t} else {\r\n");
