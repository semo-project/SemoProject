 ...
 * Generated at: 2020-03-24 09:51:04 UTC
...
public final class adminAccusationList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if("10".equals(request.getParameter("pageId"))) { 
      ...
      out.write("                    <br>\r\n");
      out.write("                    \r\n");
      out.write("                    <button class=\"btn btn-dark\" type=\"button\" onclick=\"blackList();\">신고된 회원</button>\r\n");
      out.write("                    &nbsp;\r\n");
      out.write("                    <button class=\"btn btn-light\" type=\"button\">활동 중지 회원</button>\r\n");
      out.write("\r\n");
      out.write("                    <br><br>\r\n");
      out.write("                    <div class=\"card mb-4\">\r\n");
      out.write("                        <div class=\"card-header\"><i class=\"fas fa-table mr-1\"></i>활동 중지 된 회원 목록\r\n");
      out.write("                            <button class=\"btn btn-primary\" style=\"float:right;\" id=\"searchBtn\">검색</button>\r\n");
      out.write("                            <input type=\"text\" class=\"search\" id=\"accusSearch\" style=\"float: right;\" placeholder=\"id를 입력해주세요\">\r\n");
      out.write("                        </div>\r\n");
      ...
      out.write("                                            <th></th>\r\n");
      out.write("                                            <th>Id</th>\r\n");
      out.write("                                            <th>Cease Date</th>\r\n");
      out.write("                                            <th>Period</th>\r\n");
      out.write("                                            <th>Report Count</th>\r\n");
      out.write("                                        </tr>\r\n");
      out.write("                                    </thead>\r\n");
      out.write("                                    \r\n");
      out.write("                                    <tbody>\r\n");
 ...
 long time = Math.abs((new Date().getTime() - m.getAccusationDate().getTime())/(24*60*60*1000)); 
      ...
      out.write("                                </table>\r\n");
      out.write("\r\n");
      out.write("                                <button class=\"btn btn-danger\" style=\"float: right;\" id=\"disAccus\">활중 해제</button>\r\n");
      out.write("                            </div>\r\n");
      out.write("                            \r\n");
      out.write("                            <br><br>\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
 ...
 if(search != null) { 
      ...
      out.print(contextPath);
      out.write("/accusSearch.me?pageId=3&&search=");
      out.print(search );
...
if(currentPage == 1){ 
      ...
      out.write("\t\t\t\t\t\t\t<button onclick=\"location.href='");
      out.print(contextPath);
      out.write("/accusSearch.me?pageId=3&&currentPage=");
...
if(currentPage == maxPage){ 
      ...
      out.write("\t\t\t\t\t\t\t<button onclick=\"location.href='");
      out.print(contextPath);
      out.write("/accusation.me?pageId=3';\" class=\"btn btn-outline-primary\"> &lt;&lt; </button>\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t<!-- 이전페이지(<) -->\r\n");
      out.write("\t\t\t\t\t\t\t");
if(currentPage == 1){ 
      ...
      out.write("\t\t\t\t\t\t\t<button onclick=\"location.href='");
      out.print(contextPath);
      out.write("/accusation.me?pageId=3&&currentPage=");
      out.print(currentPage-1);
      out.write("';\" class=\"btn btn-outline-primary\"> &lt; </button>\r\n");
      out.write("\t\t\t\t\t\t\t");
} 
...
if(currentPage == maxPage){ 
 ...
 accusMessage = null; 
      ...
      out.write("\t    \t\tvar search = $(\"#accusSearch\").val();\r\n");
      out.write("    \t\t\t\r\n");
      out.write("\t    \t\tlocation.href = \"");
      out.print(contextPath);
      out.write("/accusSearch.me?pageId=3&&search=\" + search;\r\n");
      out.write("    \t\t});\r\n");
      out.write("    \t\t$(\"#disAccus\").click(function() {\r\n");
      ...
      out.write("    \t\t\t\tlocation.href = \"");
      out.print(contextPath);
      out.write("/disAccus.me?pageId=3&&accusNo=\" + accusNo;\r\n");
      out.write("    \t\t\t} else {\r\n");
      out.write("    \t\t\t\talert(\"활동중지를 해제할 회원을 선택해주세요.\");\r\n");
      out.write("    \t\t\t}\r\n");
      out.write("    \t\t});\r\n");
      out.write("    \t\t\r\n");
      out.write("    \t});\r\n");
