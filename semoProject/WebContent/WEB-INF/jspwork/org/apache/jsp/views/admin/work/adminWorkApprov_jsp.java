 ...
 * Generated at: 2020-03-26 11:34:17 UTC
...
public final class adminWorkApprov_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/admin/work/../common/adminTopNav.jsp", Long.valueOf(1585032961259L));
    _jspx_dependants.put("/views/admin/work/../common/adminFooter.jsp", Long.valueOf(1584369612000L));
    _jspx_dependants.put("/views/admin/work/../common/adminSideNav.jsp", Long.valueOf(1584967810000L));
  }
...
if("10".equals(request.getParameter("pageId"))) { 
      ...
      out.write("                    <br>\r\n");
      out.write("                    \r\n");
      out.write("                    <button class=\"btn btn-light\" type=\"button\">작품 등록 대기</button>\r\n");
      out.write("                    &nbsp;\r\n");
      out.write("                    <button class=\"btn btn-dark\" type=\"button\" onclick=\"goEpisode();\">에피소드 등록 대기</button>\r\n");
      out.write("                    \r\n");
      out.write("                    \r\n");
      out.write("                    <br><br>\r\n");
      out.write("                    <div class=\"card mb-4\">\r\n");
      out.write("                        <div class=\"card-header\"><i class=\"fas fa-table mr-1\"></i>작품 등록 신청 목록\r\n");
      out.write("                            <button class=\"btn btn-primary\" style=\"float:right;\" id=\"searchBtn\">검색</button>\r\n");
      out.write("                            <input type=\"text\" class=\"search\" id=\"workApprovSearch\" style=\"float: right;\" placeholder=\"작품명을 입력하세요\">\r\n");
      out.write("                            \r\n");
      out.write("                        </div>\r\n");
 ...
 for(Work w : list) { 
      out.write("   \t\r\n");
      out.write("\t                                        <tr> \r\n");
      out.write("\t                                            <td><input type=\"checkbox\" name=\"approvCheck\" value=\"");
      ...
      out.write("\t                                            <td><a href=\"");
      out.print(contextPath);
      out.write("/approvDetail.wo?pageId=5&&no=");
      out.print(w.getWorkNo());
      out.write('"');
      out.write('>');
      ...
      out.write("                                </table>\r\n");
      out.write("\r\n");
      out.write("                                <button class=\"btn btn-danger\" style=\"float: right;\" id=\"approvBtn\">승인</button>\r\n");
      out.write("                                <!-- <input type=\"submit\" class=\"btn btn-danger\" style=\"float: right;\" value=\"승인\"> -->\r\n");
      out.write("                            </div>\r\n");
      out.write("                            \r\n");
      out.write("                            ");
 if(list.size() != 0) { 
 ...
 if(search != null) { 
      ...
      out.print(contextPath);
      out.write("/workSearchApprov.wo?pageId=5&&search=");
      out.print(search );
...
if(currentPage == 1){ 
      ...
      out.write("\t\t\t\t\t\t\t<button onclick=\"location.href='");
      out.print(contextPath);
      out.write("/workSearchApprov.wo?pageId=5&&currentPage=");
...
if(currentPage == maxPage){ 
      ...
      out.write("\t\t\t\t\t\t\t<button onclick=\"location.href='");
      out.print(contextPath);
      out.write("/workApprov.wo?pageId=5';\" class=\"btn btn-outline-primary\"> &lt;&lt; </button>\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t<!-- 이전페이지(<) -->\r\n");
      out.write("\t\t\t\t\t\t\t");
if(currentPage == 1){ 
      ...
      out.write("\t\t\t\t\t\t\t<button onclick=\"location.href='");
      out.print(contextPath);
      out.write("/workApprov.wo?pageId=5&&currentPage=");
      out.print(currentPage-1);
      out.write("';\" class=\"btn btn-outline-primary\"> &lt; </button>\r\n");
      out.write("\t\t\t\t\t\t\t");
} 
...
if(currentPage == maxPage){ 
      ...
      out.write("    \r\n");
      out.write("    <script>\r\n");
      out.write("    \tfunction goEpisode() {\r\n");
      out.write("    \t\tlocation.href = \"");
      out.print(contextPath);
      out.write("/episodeApprov.wo?pageId=5\";\r\n");
      out.write("    \t}\r\n");
      out.write("    \t\r\n");
      out.write("    \t$(function(){    \r\n");
      out.write("    \t\t\r\n");
 ...
 approvMsg = null; 
      ...
      out.write("               var search = $(\"#workApprovSearch\").val();\r\n");
      out.write("               location.href = \"");
      out.print(contextPath);
      out.write("/workSearchApprov.wo?pageId=5&&search=\" + search;\r\n");
      out.write("            });\r\n");
      out.write("            \r\n");
      out.write("        \t// 승인처리\r\n");
      out.write("            $(\"#approvBtn\").click(function() {\r\n");
      out.write("    \t\t\tvar approvArr = new Array();\r\n");
      out.write("    \t\t\t\r\n");
      out.write("    \t\t\t$('input:checkbox[name=approvCheck]:checked').each(function() {\r\n");
      out.write("    \t\t\t\tapprovArr.push(this.value);\r\n");
      out.write("    \t\t\t});\r\n");
      out.write("    \t\t\t\r\n");
      out.write("    \t\t\tif(approvArr.length >= 1) {\r\n");
      out.write("    \t\t\t\tvar no = approvArr.join(\", \");\r\n");
      out.write("    \t\t\t\tlocation.href = \"");
      out.print(contextPath);
      out.write("/approvConfirm.wo?pageId=5&&no=\" + no;\r\n");
      out.write("    \t\t\t} else {\r\n");
      out.write("    \t\t\t\talert(\"승인할 작품을 선택해주세요\");\r\n");
      out.write("    \t\t\t}\r\n");
      out.write("    \t\t});\r\n");
      out.write("        });\r\n");
      out.write("    </script>\r\n");
