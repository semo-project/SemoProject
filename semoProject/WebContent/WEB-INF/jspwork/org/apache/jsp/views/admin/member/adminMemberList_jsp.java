 ...
 * Generated at: 2020-03-29 06:15:22 UTC
...
if("10".equals(request.getParameter("pageId"))) { 
      ...
      out.write("\t\t\t\t\t<br>\r\n");
      out.write("                    \r\n");
      out.write("\t\t\t\t\t<button class=\"btn btn-light\" type=\"button\">전체 회원</button>\r\n");
      out.write("\t\t\t\t\t&nbsp;\r\n");
      out.write("\t\t\t\t\t<button class=\"btn btn-dark\" type=\"button\" onclick=\"goWriterApprv();\">작가 대기 회원</button>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t<br><br>\r\n");
      out.write("\t\t\t\t\t<div class=\"card mb-4\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"card-header\"><i class=\"fas fa-table mr-1\"></i>전체 회원 목록\r\n");
      out.write("\t\t\t\t\t\t\t<button class=\"btn btn-primary\" style=\"float:right;\" id=\"searchBtn\">검색</button>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" class=\"search\" id=\"memberSearch\" style=\"float: right;\" placeholder=\"이름을 입력해주세요\" \r\n");
      out.write("\t\t\t\t\t\t\tvalue=\"");
 if(search != null) { 
      out.write(' ');
      out.print( search);
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<th>Id</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<th style=\"width:15%\">Phone</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<th>Gender</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<th>Age</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<th>Ent Date</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</thead>\r\n");
      out.write("                                    \r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tbody>\r\n");
 ...
 if(search != null) { 
      ...
      out.print(contextPath);
      out.write("/searchMem.me?pageId=1&&name=");
      out.print(search );
...
if(currentPage == 1){ 
      ...
      out.write("\t\t\t\t\t\t\t<button onclick=\"location.href='");
      out.print(contextPath);
      out.write("/searchMem.me?pageId=1&&currentPage=");
...
if(currentPage == maxPage){ 
      ...
      out.write("\t\t\t\t\t\t\t<button onclick=\"location.href='");
      out.print(contextPath);
      out.write("/list.me?pageId=1';\" class=\"btn btn-outline-primary\"> &lt;&lt; </button>\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t<!-- 이전페이지(<) -->\r\n");
      out.write("\t\t\t\t\t\t\t");
if(currentPage == 1){ 
      ...
      out.write("\t\t\t\t\t\t\t<button onclick=\"location.href='");
      out.print(contextPath);
      out.write("/list.me?pageId=1&&currentPage=");
      out.print(currentPage-1);
      out.write("';\" class=\"btn btn-outline-primary\"> &lt; </button>\r\n");
      out.write("\t\t\t\t\t\t\t");
} 
...
if(currentPage == maxPage){ 
      ...
      out.write("    \r\n");
      out.write("\t<script>\r\n");
      out.write("    \tfunction goWriterApprv() {\r\n");
      out.write("    \t\tlocation.href = \"");
      out.print(contextPath);
      out.write("/writerApprv.wr?pageId=1\";\r\n");
      out.write("    \t}\r\n");
      out.write("    \t$(function(){\r\n");
      out.write("            $(\"#searchBtn\").click(function(){\r\n");
      out.write("               var name = $(\"#memberSearch\").val();\r\n");
      out.write("               location.href = \"");
      out.print(contextPath);
      out.write("/searchMem.me?pageId=1&&name=\" + name;\r\n");
      out.write("            });\r\n");
      out.write("         });\r\n");
      out.write("    </script>\r\n");
      out.write("</body>\r\n");
