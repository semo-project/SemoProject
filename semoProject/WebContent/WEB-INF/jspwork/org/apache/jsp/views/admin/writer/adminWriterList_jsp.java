 ...
 * Generated at: 2020-03-29 06:20:20 UTC
...
public final class adminWriterList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/admin/writer/../common/adminSideNav.jsp", Long.valueOf(1585406746386L));
    _jspx_dependants.put("/views/admin/writer/../common/adminFooter.jsp", Long.valueOf(1584369612000L));
    _jspx_dependants.put("/views/admin/writer/../common/adminTopNav.jsp", Long.valueOf(1585397356594L));
  }
...
if("10".equals(request.getParameter("pageId"))) { 
      ...
      out.write("                    <h1 class=\"mt-4\">전체 작가 보기</h1>\r\n");
      out.write("                    \r\n");
      out.write("                    <br>\r\n");
      out.write("                    <!-- <form method=\"post\" action=\"\"> -->\r\n");
      out.write("                    <button class=\"btn btn-primary\" type=\"button\" onclick=\"goRest();\">작가 해제하기</button>\r\n");
      out.write("                    &nbsp;\r\n");
      out.write("                    <!-- <button class=\"btn btn-primary\" type=\"button\" onclick=\"goRest();\">휴면 계정 전환</button> -->\r\n");
      out.write("\r\n");
      out.write("                    <br><br>\r\n");
      out.write("                    <div class=\"card mb-4\">\r\n");
      out.write("                        <div class=\"card-header\"><i class=\"fas fa-table mr-1\"></i>전체 작가 목록\r\n");
...
for(Writer w : list) { 
      out.write("\r\n");
      out.write("\t                                        <tr>\r\n");
      out.write("\t                                            <td><input type=\"checkbox\" id=\"writerAprv\" name=\"checkWriter\" value=\"");
      ...
      out.write("</td>\r\n");
      out.write("\t                                            <td>");
      out.print(w.getBankName() );
      out.write("</td>\r\n");
      out.write("\t                                            <td>");
      out.print(w.getAccountNo() );
      out.write("</td>\r\n");
      out.write("\t                                            <td><a href=\"");
      out.print(contextPath);
      out.write("/writerList.wo?pageId=4&&no=");
      out.print(w.getWriterNo());
      out.write("\">작품 리스트 보기</a></td>\r\n");
      out.write("\t                                        </tr>\r\n");
      out.write("\t                                        ");
 } 
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("\t                                    \t<tr>\r\n");
      out.write("\t                                    \t\t<td colspan=\"7\" style=\"text-align:center;\">조회된 데이터가 없습니다.</td>\r\n");
      out.write("\t                                    \t</tr>\r\n");
      out.write("\t                                    ");
 } 
      out.write("\r\n");
 ...
 if(search != null) { 
      ...
      out.print(contextPath);
      out.write("/writerSearch.wr?pageId=2&&search=");
      out.print(search );
...
if(currentPage == 1){ 
      ...
      out.write("\t\t\t\t\t\t\t<button onclick=\"location.href='");
      out.print(contextPath);
      out.write("/writerSearch.wr?pageId=2&&currentPage=");
...
if(currentPage == maxPage){ 
      ...
      out.write("\t\t\t\t\t\t\t<button onclick=\"location.href='");
      out.print(contextPath);
      out.write("/adminList.wr?pageId=2';\" class=\"btn btn-outline-primary\"> &lt;&lt; </button>\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t<!-- 이전페이지(<) -->\r\n");
      out.write("\t\t\t\t\t\t\t");
if(currentPage == 1){ 
      ...
      out.write("\t\t\t\t\t\t\t<button onclick=\"location.href='");
      out.print(contextPath);
      out.write("/adminList.wr?pageId=2&&currentPage=");
      out.print(currentPage-1);
      out.write("';\" class=\"btn btn-outline-primary\"> &lt; </button>\r\n");
      out.write("\t\t\t\t\t\t\t");
} 
...
if(currentPage == maxPage){ 
      ...
      out.write("    \t\t\tlocation.href = \"");
      out.print(contextPath);
      out.write("/writerSearch.wr?pageId=2&&search=\" + search;\r\n");
      out.write("    \t\t});\r\n");
 ...
 restMessage = null;
      ...
      out.write("    \t\t}\r\n");
      out.write("    \t});\r\n");
      out.write("    \tfunction goRest() {\r\n");
      out.write("    \t\tvar restArr = new Array();\r\n");
      out.write("    \t\t\r\n");
      out.write("    \t\t$('input:checkbox[name=checkWriter]:checked').each(function() {\r\n");
      out.write("    \t\t\trestArr.push(this.value);\r\n");
      out.write("    \t\t});\r\n");
      out.write("    \t\t\r\n");
      out.write("    \t\tif(restArr.length >= 1) {\r\n");
      out.write("    \t\t\tvar restNo = restArr.join(\", \");\r\n");
      out.write("    \t\t\tlocation.href = \"");
      out.print(contextPath);
      out.write("/rest.wr?pageId=2&&restNo=\" + restNo;\r\n");
      out.write("    \t\t} else {\r\n");
      out.write("    \t\t\talert(\"작가를 선택해주세요.\");\r\n");
      out.write("    \t\t}    \t\t\r\n");
      out.write("    \t}\r\n");
      out.write("    </script>\r\n");
      out.write("    <script src=\"https://code.jquery.com/jquery-3.4.1.min.js\" crossorigin=\"anonymous\"></script>\r\n");
