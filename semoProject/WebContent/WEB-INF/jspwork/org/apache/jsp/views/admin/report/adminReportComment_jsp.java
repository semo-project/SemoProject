 ...
 * Generated at: 2020-03-29 06:51:08 UTC
...
public final class adminReportComment_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/admin/report/../common/adminFooter.jsp", Long.valueOf(1584369612000L));
    _jspx_dependants.put("/views/admin/report/../common/adminTopNav.jsp", Long.valueOf(1585397356594L));
    _jspx_dependants.put("/views/admin/report/../common/adminSideNav.jsp", Long.valueOf(1585406746386L));
  }
...
if("10".equals(request.getParameter("pageId"))) { 
      ...
      out.write("                        <br>\r\n");
      out.write("\r\n");
      out.write("                        <button class=\"btn btn-dark\" type=\"button\" onclick=\"goReport();\">게시글</button>\r\n");
      out.write("                        &nbsp;\r\n");
      out.write("                        <button class=\"btn btn-light\" type=\"button\">댓글</button>                        \r\n");
      out.write("\r\n");
      out.write("                        <br><br>\r\n");
      out.write("                        <div class=\"card mb-4\">\r\n");
      out.write("                            <div class=\"card-header\"><i class=\"fas fa-table mr-1\"></i>댓글 신고 목록\r\n");
      out.write("                                <button class=\"btn btn-primary\" style=\"float:right;\" id=\"searchBtn\">검색</button>\r\n");
      out.write("                                <input type=\"text\" class=\"search\" id=\"commentSearch\" style=\"float: right;\" placeholder=\"id를 입력해주세요\">\r\n");
      out.write("                            </div>\r\n");
 ...
 for(Report r : list) { 
      ...
      out.write("\"></td>\r\n");
      out.write("\t                                                <td data-toggle=\"modal\" data-target=\"#reportModal\" data-comment=\"");
      out.print(r.getCommentContent());
      out.write("\" \r\n");
...
if(currentPage == maxPage){ 
      ...
      out.write("\t\t\t\t\t\t\t\t<button onclick=\"location.href='");
      out.print(contextPath);
      out.write("/comment.re?pageId=6';\" class=\"btn btn-outline-primary\"> &lt;&lt; </button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<!-- 이전페이지(<) -->\r\n");
      out.write("\t\t\t\t\t\t\t\t");
if(currentPage == 1){ 
      ...
      out.write("\t\t\t\t\t\t\t\t<button onclick=\"location.href='");
      out.print(contextPath);
      out.write("/comment.re?pageId=6&&currentPage=");
      out.print(currentPage-1);
      out.write("';\" class=\"btn btn-outline-primary\"> &lt; </button>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
} 
...
if(currentPage == maxPage){ 
      ...
      out.write("                            <tr>\r\n");
      out.write("                                <td>\r\n");
      out.write("                                    <label class=\"modal-title-font\">댓글 내용</label>\r\n");
      out.write("                                    <br>\r\n");
      out.write("                                    <label class=\"board-comment\"></label>\r\n");
      out.write("                                </td>\r\n");
      out.write("                            </tr>\r\n");
      out.write("                            <tr>\r\n");
      out.write("                                <td>\r\n");
      ...
      out.write("                        <button type=\"button\" class=\"btn btn-primary\">댓글 원문 보러가기</button>\r\n");
      ...
      out.write("                \tvar comment = $(event.relatedTarget).data('comment');\r\n");
      ...
      out.write("                \tmodal.find(\".board-comment\").text(comment);\r\n");
 ...
 confirmMessage = null;
      ...
      out.write("                    var search = $(\"#commentSearch\").val();\r\n");
      out.write("                    location.href = \"");
      out.print(contextPath);
      out.write("/commentSearch.re?pageId=6&&search=\" + search;\r\n");
      out.write("                });\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("             \t// 게시글 본문 보러가기\r\n");
      out.write("                $(\"#goBoard\").click(function() {\r\n");
      out.write("                \t// 게시글 댓글과 웹툰 댓글을 보여줘야 하는데, 그럼 해당 글을 보여줘야 돼\r\n");
      out.write("                \t\r\n");
      out.write("                \t//location.href = \"");
      out.print(contextPath);
      out.write("\";\r\n");
      ...
      out.write("                \t\tlocation.href= \"");
      out.print(contextPath);
      out.write("/confirm.re?report=2&&pageId=6&&no=\" + no;\r\n");
      out.write("                \t} else {\r\n");
