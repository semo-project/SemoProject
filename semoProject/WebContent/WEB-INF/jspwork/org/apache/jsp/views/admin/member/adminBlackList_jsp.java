 ...
 * Generated at: 2020-03-31 00:28:24 UTC
...
public final class adminBlackList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/admin/member/../common/adminFooter.jsp", Long.valueOf(1584369612000L));
    _jspx_dependants.put("/views/admin/member/../common/adminSideNav.jsp", Long.valueOf(1585484665815L));
    _jspx_dependants.put("/views/admin/member/../common/adminTopNav.jsp", Long.valueOf(1585397356594L));
  }
...
if("10".equals(request.getParameter("pageId"))) { 
      ...
      out.write("                    <h1 class=\"mt-4\">블랙리스트</h1>\r\n");
      out.write("                    \r\n");
      out.write("                    <br>\r\n");
      out.write("                    \r\n");
      out.write("                    <button class=\"btn btn-light\" type=\"button\">신고된 회원</button>\r\n");
      out.write("                    &nbsp;\r\n");
      out.write("                    <button class=\"btn btn-dark\" type=\"button\" onclick=\"accusation();\">활동 중지 회원</button>\r\n");
      out.write("\r\n");
      out.write("                    <br><br>\r\n");
      out.write("                    <div class=\"card mb-4\">\r\n");
      out.write("                        <div class=\"card-header\"><i class=\"fas fa-table mr-1\"></i>신고된 회원 목록\r\n");
      out.write("                            <button class=\"btn btn-primary\" style=\"float:right;\" id=\"searchBtn\">검색</button>\r\n");
      out.write("                            <input type=\"text\" class=\"search\" id=\"blackSearch\" style=\"float: right;\" placeholder=\"id를 입력해주세요\">\r\n");
      out.write("                        </div>\r\n");
      ...
      out.write("                                            <th style=\"width: 45%;\">Id</th>\r\n");
      out.write("                                            <th style=\"width: 45%;\">Report Count</th>\r\n");
      out.write("                                        </tr>\r\n");
      out.write("                                    </thead>\r\n");
      out.write("                                    \r\n");
      out.write("                                    <tbody>\r\n");
 ...
 for(Member m : list) { 
      out.write("\r\n");
      out.write("\t                                        <tr>\r\n");
      out.write("\t                                            <td><input type=\"checkbox\" name=\"accusCheck\" value=\"");
 ...
 if (m.getAccusationCount() >= 5) {
      ...
      out.write('"');
      out.write('>');
      out.print(m.getAccusationCount() );
      out.write("</td>\r\n");
      out.write("\t                                        </tr>\r\n");
      out.write("\t                                        ");
 } 
      ...
      out.write("\r\n");
      out.write("\t                                    \t<tr>\r\n");
      out.write("\t                                    \t\t<td colspan=\"3\" style=\"text-align:center;\">조회된 데이터가 없습니다</td>\r\n");
      out.write("\t                                    \t</tr>\r\n");
      out.write("\t                                    ");
 } 
      out.write("\r\n");
      ...
      out.write("                                </table>\r\n");
      out.write("\r\n");
      out.write("                                <button class=\"btn btn-danger\" style=\"float: right;\" id=\"goAccus\">활동 중지</button>\r\n");
      out.write("                            </div>\r\n");
      out.write("                            \r\n");
      out.write("                            \r\n");
      out.write("\t\t\t\t\t\t\t<br><br>\r\n");
 ...
 if(search != null) { 
      ...
      out.print(contextPath);
      out.write("/blackSearch.me?pageId=3&&search=");
      out.print(search );
...
if(currentPage == 1){ 
      ...
      out.write("\t\t\t\t\t\t\t<button onclick=\"location.href='");
      out.print(contextPath);
      out.write("/blackSearch.me?pageId=3&&currentPage=");
...
if(currentPage == maxPage){ 
      ...
      out.write("\t\t\t\t\t\t\t<button onclick=\"location.href='");
      out.print(contextPath);
      out.write("/blackList.me?pageId=3';\" class=\"btn btn-outline-primary\"> &lt;&lt; </button>\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t<!-- 이전페이지(<) -->\r\n");
      out.write("\t\t\t\t\t\t\t");
if(currentPage == 1){ 
      ...
      out.write("\t\t\t\t\t\t\t<button onclick=\"location.href='");
      out.print(contextPath);
      out.write("/blackList.me?pageId=3&&currentPage=");
      out.print(currentPage-1);
      out.write("';\" class=\"btn btn-outline-primary\"> &lt; </button>\r\n");
      out.write("\t\t\t\t\t\t\t");
} 
...
if(currentPage == maxPage){ 
      ...
      out.write("    <script>\r\n");
      out.write("    \r\n");
      out.write("    \tfunction accusation() {\r\n");
      out.write("    \t\tlocation.href = \"");
      out.print(contextPath);
      out.write("/accusation.me?pageId=3\";\r\n");
      out.write("    \t}\r\n");
      out.write("    \t$(function() {\r\n");
      out.write("\t\t\tvar msg = \"");
      out.print(accusMessage);
      out.write("\";\r\n");
      out.write("    \t\t\r\n");
 ...
 accusMessage = null; 
      ...
      out.write("\t    \t\tvar search = $(\"#blackSearch\").val();\r\n");
      out.write("    \t\t\t\r\n");
      out.write("\t    \t\tlocation.href = \"");
      out.print(contextPath);
      out.write("/blackSearch.me?pageId=3&&search=\" + search;\r\n");
      out.write("    \t\t});\r\n");
      out.write("    \t\t$(\"#goAccus\").click(function() {\r\n");
