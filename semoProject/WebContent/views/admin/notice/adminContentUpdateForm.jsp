        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    ...
                    <br>
                    <form method="post" action="<%=contextPath%>/adContentUpdate.no?pageId=9">
                    <div class="card mb-4">
                        <div class="card-header">
                        	<input type="hidden" name="no" value="<%=c.getContactNo()%>">
                        	<input type="text" class="form-control" name="title" value="<%=c.getContactTitle()%>">
                        </div>
                        <div class="card-body">

                            <div class="table-responsive">	
                                <textarea name="content" class="diyDiv mb-4" style="width:100%; height:450px; resize:none;"><%=c.getContatctContent() %></textarea>
								<div>
									<span>
