...
import com.kh.epLike.model.service.EpLikeService;
...
public class MyPageLikeServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount = new EpLikeService().countList(loginUser.getMemberNo());
		...
		ArrayList<EpLike> list = new EpLikeService().selectList(pi, loginUser.getMemberNo());
