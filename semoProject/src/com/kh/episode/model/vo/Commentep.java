...
public class Commentep {
	...
	public Commentep(int commentNo, int comBoardNo, String commentWriter, String commentContent, Date commentDate,
	...
	public Commentep(String commentWriter, String commentContent) {
		super();
		this.commentWriter = commentWriter;
		this.commentContent = commentContent;
	}
